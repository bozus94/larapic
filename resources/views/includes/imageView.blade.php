    ...
    <div class="card-footer">
        @if ($home)
            <div class="img_info">
                ...
                {{-- {{ \CustomTime::longTimeFilter($image->created_at) }} --}}
                <span class=" text-secondary pl-2"> {{ \CustomTime::longTimeFilter($image->created_at) }}</span>
                <hr>
                <div class="row justify-content-around" >
                    <div class="likes action_item">
                        <a href="#" class="align-content-center text-decoration-none text-muted rounded py-2 px-5 btn-light">
                            <i class="far fa-heart"></i>
                            <span class="text-black-50 pl-2">10k</span>
                        </a>           
                    </div>
                    <div class="share action_item">
                        <a href="{{ route('image.detail',['filename'=>$image->id]) }}" class="align-content-center text-decoration-none text-muted rounded py-2 px-5 btn-light">
        ...
        @else
            <div class="img_info">
                ...
                <div class="row img_stats_actions">
                    <div class="likes action_item">
                        <a href="" class="align-content-center btn-light rounded">
                ...
                <div class="new_comment">
                    <form action="{{ route('comment.new') }}" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control @error('comment_content') is-invalid @enderror" placeholder="Añade un comentario" aria-label="Añade un comentario" name="comment_content" aria-describedby="basic-addon2">
                    ...
                    <li class="comment list-group-item d-flex justify-content-between">
                        <div class="comment_container d-flex flex-row align-content-center">
                                ...
                                <div class="comment_content">
                                    <div>
                                        <a href="#" class="btn btn-link text-reset">{{ $comment->user->name . ' ' . $comment->user->surname  }}</a>
                                        <span>{{ $comment->content }}</span> 
                                    </div>
                                    <div class="comment_actions ">
                                        <a href="#" class="like_comment">Me gusta</a>
                                        <a href="#" class="comment_response">Responder</a>
                                        <span class="ago text-secondary">{{ strtolower(\CustomTime::longTimeFilterShort($comment->created_at)) }}</span>
                                    </div>
                            </div>
                        </div>
